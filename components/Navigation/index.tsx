...
const Navigation = ({offset, wide = false}: NavProps) => {
  ...
  return (
    <div className='chakra-scope'>
      <FrostedContainer backgroundColor={colorMode === "dark" ? "rgba(8, 0, 25, .5)":"rgba(255, 255, 255, .5)"}>
        <Container maxW={wide ? "container.lg":"container.md"}>
          ...
          >
            <Flex align="center">
              <Link href="/">
                <IconButton
                  ...
                  aria-label="Home"
                  icon={<FiHome size={24} color= {colorMode === "dark" ? "white" : "black"}/>}
                />
              </Link>
            </Flex>
            ...
            >
              <Link href="/about">
                <Button variant="ghost" mr={2} _hover={{backgroundColor: hoverBackgroundColor}}>
                  About
                </Button>
              </Link>
